...
namespace Alba.CsCss.Style
{
    internal static partial class nsCSSPseudoElements
    {
        ...
        public static string firstLetter = ":first-letter";
        public static string firstLine = ":first-line";
        public static string mozSelection = ":-moz-selection";
        public static string mozFocusInner = ":-moz-focus-inner";
        public static string mozFocusOuter = ":-moz-focus-outer";
        public static string mozListBullet = ":-moz-list-bullet";
        public static string mozListNumber = ":-moz-list-number";
        public static string mozMathStretchy = ":-moz-math-stretchy";
        public static string mozMathAnonymous = ":-moz-math-anonymous";
        public static string mozProgressBar = ":-moz-progress-bar";
        public static string mozRangeTrack = ":-moz-range-track";
        public static string mozRangeProgress = ":-moz-range-progress";
        public static string mozRangeThumb = ":-moz-range-thumb";

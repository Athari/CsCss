...
namespace Alba.CsCss.Style
{
    public enum nsCSSProperty
    {
        ...
        Alias_MozTransformOrigin,
        Alias_MozPerspectiveOrigin,
        Alias_MozPerspective,
        Alias_MozTransformStyle,
        Alias_MozBackfaceVisibility,
        Alias_MozBorderImage,
        Alias_MozTransition,
        Alias_MozTransitionDelay,
        Alias_MozTransitionDuration,
        Alias_MozTransitionProperty,
        Alias_MozTransitionTimingFunction,
        Alias_MozAnimation,
        Alias_MozAnimationDelay,
        Alias_MozAnimationDirection,
        Alias_MozAnimationDuration,
        Alias_MozAnimationFillMode,
        Alias_MozAnimationIterationCount,
        Alias_MozAnimationName,
        Alias_MozAnimationPlayState,
        Alias_MozAnimationTimingFunction,
        COUNT_with_aliases,
        [EditorBrowsable(EditorBrowsableState.Never)]

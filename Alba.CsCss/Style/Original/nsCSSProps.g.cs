...
namespace Alba.CsCss.Style
{
    internal partial class nsCSSProps
    {
        ...
        public static readonly int32_t[] kAppearanceKTable = {
          (int)nsCSSKeyword.none,                   0,
          (int)nsCSSKeyword.button,                 0,
          (int)nsCSSKeyword.radio,                  0,
          (int)nsCSSKeyword.checkbox,               0,
          (int)nsCSSKeyword.button_bevel,           0,
          (int)nsCSSKeyword.toolbox,                0,
          (int)nsCSSKeyword.toolbar,                0,
          (int)nsCSSKeyword.toolbarbutton,          0,
          (int)nsCSSKeyword.toolbargripper,         0,
          (int)nsCSSKeyword.dualbutton,             0,
          (int)nsCSSKeyword.toolbarbutton_dropdown, 0,
          (int)nsCSSKeyword.button_arrow_up,        0,
          (int)nsCSSKeyword.button_arrow_down,      0,
          (int)nsCSSKeyword.button_arrow_next,      0,
          (int)nsCSSKeyword.button_arrow_previous,  0,
          (int)nsCSSKeyword.meterbar,               0,
          (int)nsCSSKeyword.meterchunk,             0,
          (int)nsCSSKeyword.separator,              0,
          (int)nsCSSKeyword.splitter,               0,
          (int)nsCSSKeyword.statusbar,              0,
          (int)nsCSSKeyword.statusbarpanel,         0,
          (int)nsCSSKeyword.resizerpanel,           0,
          (int)nsCSSKeyword.resizer,                0,
          (int)nsCSSKeyword.listbox,                0,
          (int)nsCSSKeyword.listitem,               0,
          (int)nsCSSKeyword.treeview,               0,
          (int)nsCSSKeyword.treeitem,               0,
          (int)nsCSSKeyword.treetwisty,             0,
          (int)nsCSSKeyword.treetwistyopen,         0,
          (int)nsCSSKeyword.treeline,               0,
          (int)nsCSSKeyword.treeheader,             0,
          (int)nsCSSKeyword.treeheadercell,         0,
          (int)nsCSSKeyword.treeheadersortarrow,    0,
          (int)nsCSSKeyword.progressbar,            0,
          (int)nsCSSKeyword.progresschunk,          0,
          (int)nsCSSKeyword.progressbar_vertical,   0,
          (int)nsCSSKeyword.progresschunk_vertical, 0,
          (int)nsCSSKeyword.tab,                    0,
          (int)nsCSSKeyword.tabpanels,              0,
          (int)nsCSSKeyword.tabpanel,               0,
          (int)nsCSSKeyword.tab_scroll_arrow_back,  0,
          (int)nsCSSKeyword.tab_scroll_arrow_forward, 0,
          (int)nsCSSKeyword.tooltip,                0,
          (int)nsCSSKeyword.spinner,                0,
          (int)nsCSSKeyword.spinner_upbutton,       0,
          (int)nsCSSKeyword.spinner_downbutton,     0,
          (int)nsCSSKeyword.spinner_textfield,      0,
          (int)nsCSSKeyword.scrollbar,              0,
          (int)nsCSSKeyword.scrollbar_small,        0,
          (int)nsCSSKeyword.scrollbarbutton_up,     0,
          (int)nsCSSKeyword.scrollbarbutton_down,   0,
          (int)nsCSSKeyword.scrollbarbutton_left,   0,
          (int)nsCSSKeyword.scrollbarbutton_right,  0,
          (int)nsCSSKeyword.scrollbartrack_horizontal,    0,
          (int)nsCSSKeyword.scrollbartrack_vertical,      0,
          (int)nsCSSKeyword.scrollbarthumb_horizontal,    0,
          (int)nsCSSKeyword.scrollbarthumb_vertical,      0,
          (int)nsCSSKeyword.textfield,              0,
          (int)nsCSSKeyword.textfield_multiline,    0,
          (int)nsCSSKeyword.caret,                  0,
          (int)nsCSSKeyword.searchfield,            0,
          (int)nsCSSKeyword.menulist,               0,
          (int)nsCSSKeyword.menulist_button,        0,
          (int)nsCSSKeyword.menulist_text,          0,
          (int)nsCSSKeyword.menulist_textfield,     0,
          (int)nsCSSKeyword.range,                  0, // disabled on branch 0,
          (int)nsCSSKeyword.range_thumb,            0, // disabled on branch 0,
          (int)nsCSSKeyword.scale_horizontal,       0,
          (int)nsCSSKeyword.scale_vertical,         0,
          (int)nsCSSKeyword.scalethumb_horizontal,  0,
          (int)nsCSSKeyword.scalethumb_vertical,    0,
          (int)nsCSSKeyword.scalethumbstart,        0,
          (int)nsCSSKeyword.scalethumbend,          0,
          (int)nsCSSKeyword.scalethumbtick,         0,
          (int)nsCSSKeyword.groupbox,               0,
          (int)nsCSSKeyword.checkbox_container,     0,
          (int)nsCSSKeyword.radio_container,        0,
          (int)nsCSSKeyword.checkbox_label,         0,
          (int)nsCSSKeyword.radio_label,            0,
          (int)nsCSSKeyword.button_focus,           0,
          (int)nsCSSKeyword.window,                 0,
          (int)nsCSSKeyword.dialog,                 0,
          (int)nsCSSKeyword.menubar,                0,
          (int)nsCSSKeyword.menupopup,              0,
          (int)nsCSSKeyword.menuitem,               0,
          (int)nsCSSKeyword.checkmenuitem,          0,
          (int)nsCSSKeyword.radiomenuitem,          0,
          (int)nsCSSKeyword.menucheckbox,           0,
          (int)nsCSSKeyword.menuradio,              0,
          (int)nsCSSKeyword.menuseparator,          0,
          (int)nsCSSKeyword.menuarrow,              0,
          (int)nsCSSKeyword.menuimage,              0,
          (int)nsCSSKeyword.menuitemtext,           0,
          (int)nsCSSKeyword._moz_win_media_toolbox, 0,
          (int)nsCSSKeyword._moz_win_communications_toolbox, 0,
          (int)nsCSSKeyword._moz_win_browsertabbar_toolbox,  0,
          (int)nsCSSKeyword._moz_win_glass,         0,
          (int)nsCSSKeyword._moz_win_borderless_glass,      0,
          (int)nsCSSKeyword._moz_mac_unified_toolbar,       0,
          (int)nsCSSKeyword._moz_window_titlebar,           0,
          (int)nsCSSKeyword._moz_window_titlebar_maximized, 0,
          (int)nsCSSKeyword._moz_window_frame_left,         0,
          (int)nsCSSKeyword._moz_window_frame_right,        0,
          (int)nsCSSKeyword._moz_window_frame_bottom,       0,
          (int)nsCSSKeyword._moz_window_button_close,       0,
          (int)nsCSSKeyword._moz_window_button_minimize,    0,
          (int)nsCSSKeyword._moz_window_button_maximize,    0,
          (int)nsCSSKeyword._moz_window_button_restore,     0,
          (int)nsCSSKeyword._moz_window_button_box,         0,
          (int)nsCSSKeyword._moz_window_button_box_maximized, 0,
          (int)nsCSSKeyword._moz_win_exclude_glass,         0,
          (int)nsCSSKeyword.UNKNOWN,-1
        };
        ...
        public static readonly int32_t[] kColorKTable = {
          (int)nsCSSKeyword.activeborder, LookAndFeel::eColorID_activeborder,
          (int)nsCSSKeyword.activecaption, LookAndFeel::eColorID_activecaption,
          (int)nsCSSKeyword.appworkspace, LookAndFeel::eColorID_appworkspace,
          (int)nsCSSKeyword.background, LookAndFeel::eColorID_background,
          (int)nsCSSKeyword.buttonface, LookAndFeel::eColorID_buttonface,
          (int)nsCSSKeyword.buttonhighlight, LookAndFeel::eColorID_buttonhighlight,
          (int)nsCSSKeyword.buttonshadow, LookAndFeel::eColorID_buttonshadow,
          (int)nsCSSKeyword.buttontext, LookAndFeel::eColorID_buttontext,
          (int)nsCSSKeyword.captiontext, LookAndFeel::eColorID_captiontext,
          (int)nsCSSKeyword.graytext, LookAndFeel::eColorID_graytext,
          (int)nsCSSKeyword.highlight, LookAndFeel::eColorID_highlight,
          (int)nsCSSKeyword.highlighttext, LookAndFeel::eColorID_highlighttext,
          (int)nsCSSKeyword.inactiveborder, LookAndFeel::eColorID_inactiveborder,
          (int)nsCSSKeyword.inactivecaption, LookAndFeel::eColorID_inactivecaption,
          (int)nsCSSKeyword.inactivecaptiontext, LookAndFeel::eColorID_inactivecaptiontext,
          (int)nsCSSKeyword.infobackground, LookAndFeel::eColorID_infobackground,
          (int)nsCSSKeyword.infotext, LookAndFeel::eColorID_infotext,
          (int)nsCSSKeyword.menu, LookAndFeel::eColorID_menu,
          (int)nsCSSKeyword.menutext, LookAndFeel::eColorID_menutext,
          (int)nsCSSKeyword.scrollbar, LookAndFeel::eColorID_scrollbar,
          (int)nsCSSKeyword.threeddarkshadow, LookAndFeel::eColorID_threeddarkshadow,
          (int)nsCSSKeyword.threedface, LookAndFeel::eColorID_threedface,
          (int)nsCSSKeyword.threedhighlight, LookAndFeel::eColorID_threedhighlight,
          (int)nsCSSKeyword.threedlightshadow, LookAndFeel::eColorID_threedlightshadow,
          (int)nsCSSKeyword.threedshadow, LookAndFeel::eColorID_threedshadow,
          (int)nsCSSKeyword.window, LookAndFeel::eColorID_window,
          (int)nsCSSKeyword.windowframe, LookAndFeel::eColorID_windowframe,
          (int)nsCSSKeyword.windowtext, LookAndFeel::eColorID_windowtext,
          (int)nsCSSKeyword._moz_activehyperlinktext, NS_COLOR_MOZ_ACTIVEHYPERLINKTEXT,
          (int)nsCSSKeyword._moz_buttondefault, LookAndFeel::eColorID__moz_buttondefault,
          (int)nsCSSKeyword._moz_buttonhoverface, LookAndFeel::eColorID__moz_buttonhoverface,
          (int)nsCSSKeyword._moz_buttonhovertext, LookAndFeel::eColorID__moz_buttonhovertext,
          (int)nsCSSKeyword._moz_cellhighlight, LookAndFeel::eColorID__moz_cellhighlight,
          (int)nsCSSKeyword._moz_cellhighlighttext, LookAndFeel::eColorID__moz_cellhighlighttext,
          (int)nsCSSKeyword._moz_eventreerow, LookAndFeel::eColorID__moz_eventreerow,
          (int)nsCSSKeyword._moz_field, LookAndFeel::eColorID__moz_field,
          (int)nsCSSKeyword._moz_fieldtext, LookAndFeel::eColorID__moz_fieldtext,
          (int)nsCSSKeyword._moz_default_background_color, NS_COLOR_MOZ_DEFAULT_BACKGROUND_COLOR,
          (int)nsCSSKeyword._moz_default_color, NS_COLOR_MOZ_DEFAULT_COLOR,
          (int)nsCSSKeyword._moz_dialog, LookAndFeel::eColorID__moz_dialog,
          (int)nsCSSKeyword._moz_dialogtext, LookAndFeel::eColorID__moz_dialogtext,
          (int)nsCSSKeyword._moz_dragtargetzone, LookAndFeel::eColorID__moz_dragtargetzone,
          (int)nsCSSKeyword._moz_hyperlinktext, NS_COLOR_MOZ_HYPERLINKTEXT,
          (int)nsCSSKeyword._moz_html_cellhighlight, LookAndFeel::eColorID__moz_html_cellhighlight,
          (int)nsCSSKeyword._moz_html_cellhighlighttext, LookAndFeel::eColorID__moz_html_cellhighlighttext,
          (int)nsCSSKeyword._moz_mac_chrome_active, LookAndFeel::eColorID__moz_mac_chrome_active,
          (int)nsCSSKeyword._moz_mac_chrome_inactive, LookAndFeel::eColorID__moz_mac_chrome_inactive,
          (int)nsCSSKeyword._moz_mac_focusring, LookAndFeel::eColorID__moz_mac_focusring,
          (int)nsCSSKeyword._moz_mac_menuselect, LookAndFeel::eColorID__moz_mac_menuselect,
          (int)nsCSSKeyword._moz_mac_menushadow, LookAndFeel::eColorID__moz_mac_menushadow,
          (int)nsCSSKeyword._moz_mac_menutextdisable, LookAndFeel::eColorID__moz_mac_menutextdisable,
          (int)nsCSSKeyword._moz_mac_menutextselect, LookAndFeel::eColorID__moz_mac_menutextselect,
          (int)nsCSSKeyword._moz_mac_disabledtoolbartext, LookAndFeel::eColorID__moz_mac_disabledtoolbartext,
          (int)nsCSSKeyword._moz_mac_alternateprimaryhighlight, LookAndFeel::eColorID__moz_mac_alternateprimaryhighlight,
          (int)nsCSSKeyword._moz_mac_secondaryhighlight, LookAndFeel::eColorID__moz_mac_secondaryhighlight,
          (int)nsCSSKeyword._moz_menuhover, LookAndFeel::eColorID__moz_menuhover,
          (int)nsCSSKeyword._moz_menuhovertext, LookAndFeel::eColorID__moz_menuhovertext,
          (int)nsCSSKeyword._moz_menubartext, LookAndFeel::eColorID__moz_menubartext,
          (int)nsCSSKeyword._moz_menubarhovertext, LookAndFeel::eColorID__moz_menubarhovertext,
          (int)nsCSSKeyword._moz_oddtreerow, LookAndFeel::eColorID__moz_oddtreerow,
          (int)nsCSSKeyword._moz_visitedhyperlinktext, NS_COLOR_MOZ_VISITEDHYPERLINKTEXT,
          (int)nsCSSKeyword.currentcolor, NS_COLOR_CURRENTCOLOR,
          (int)nsCSSKeyword._moz_win_mediatext, LookAndFeel::eColorID__moz_win_mediatext,
          (int)nsCSSKeyword._moz_win_communicationstext, LookAndFeel::eColorID__moz_win_communicationstext,
          (int)nsCSSKeyword._moz_nativehyperlinktext, LookAndFeel::eColorID__moz_nativehyperlinktext,
          (int)nsCSSKeyword._moz_comboboxtext, LookAndFeel::eColorID__moz_comboboxtext,
          (int)nsCSSKeyword._moz_combobox, LookAndFeel::eColorID__moz_combobox,
          (int)nsCSSKeyword.UNKNOWN,-1
        };
        ...
        public static readonly int32_t[] kObjectPatternKTable = {
          (int)nsCSSKeyword._moz_objectfill, NS_COLOR_OBJECTFILL,
          (int)nsCSSKeyword._moz_objectstroke, NS_COLOR_OBJECTSTROKE,
          (int)nsCSSKeyword.UNKNOWN,-1
        };
